    ...
    <div className="bg-gray-800 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition">
      <div className="w-full h-40 md:h-48 lg:h-56 bg-gray-700 flex items-center justify-center overflow-hidden">
        {!imgError ? (
          ...
          <div className="w-full h-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white text-center px-4">
      ...
      <div className="p-4">
        ...
        <p className="text-sm text-gray-300 mt-1">{design.description}</p>
        <div className="mt-3 flex items-center justify-between">
          <div className="text-blue-300 font-bold">₦{design.price.toLocaleString()}</div>
