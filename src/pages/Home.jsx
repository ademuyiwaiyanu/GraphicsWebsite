    ...
    <div className=" text-slate-100 antialiased">
      <div className="flex flex-col items-center justify-center gap-8">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-white mb-4">Lanshy Design</h1>
          <p className="text-gray-300 mb-6">Graphic Designer — Creating Beautiful Designs for Your Brand</p>
          <Link to="/designs" className="bg-pink-600 hover:bg-slate-700 text-white px-4 py-2 rounded">
            Browse Designs
          </Link>
        </div>

        <div className="w-full max-w-4xl px-4">
          <h2 className="text-2xl font-semibold text-pink-600 mb-4 text-center">Featured Designs</h2>
